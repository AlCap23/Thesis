...
&= \frac{K_{22} K_{11} -  K_{12}^2}{K_{11}K_{22}- K_{12}K_{21}}\\
&= 1
\end{split}
...
\begin{align}
\begin{split}
T_{11}^* & \approx \frac{K_{11} D_{11} T_{11} + K_{12} D_{21} T_{12}}{ K_{11}^*} \\
& \approx \frac{3 - 3 ~\left(\frac{2}{3}\right) \left(\frac{1}{3} \right)}{1} \\
& \approx \\
& \approx 10.333
\end{split}
