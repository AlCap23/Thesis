...
\begin{figure}[H]\centering
  \def\svgwidth{\textwidth}
  \includesvg{Area_Bode_Phase.svg}
...
The system of equations as described above are called area-based methods, \cite{Fedele2009a}, with regards to its visualization displayed in Fig.\ref{c:identification:f:Area} . Another, likewise valid understanding is given as the minimization of the integral of the error between the real system and the model over time.\\

\begin{figure}[H]\centering
\includesvg[width = \textwidth]{Graphics/FOTD_AREA_INTERPRETATION.svg}
\caption{Interpretation of the Integral Fitting Approach using Areas}
