function C = Decoupling_D(TF,Constrains,Method,SetPointWeight)
...
%K_p(1,2) = -1/KV(1,1)*K_p(2,2);
%K_p(2,1) = -1/KV(2,2)*K_p(1,1);

%K_i(1,2) = -TF(1,2)/KV(1,1)*K_i(2,2);
%K_i(2,1) = -TF(2,1)/KV(2,2)*K_i(1,1);
