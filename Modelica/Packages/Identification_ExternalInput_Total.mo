  ...
  Icon(coordinateSystem(
      ...
      initialScale=0.1), graphics={Bitmap(extent={{-100,-100},{100,100}},
        ...
        fileName="modelica://TIL/Images/TIL.png")}),
             uses(TILMedia(version="3.4.1"), Modelica(version="3.2.1")),
preferedView="info",
version="3.4.1",
Documentation(info="<html><br>
  ...
  package Identification_Physical_System
    ...
    equation
      ...
      connect(firstOrder2.u, Ventil) annotation (Line(points={{-342,148},{-368,
              148},{-368,154},{-386,154},{-386,328},{38,328},{38,300}}, color={
              0,0,127}));
...
model FMU_Physical_HP_HT_Control_Identification_ExternalInput
 extends FMU_Physical.HP_HT_Control.Identification_ExternalInput;
  annotation(experiment(
    StopTime=1,
    __Dymola_NumberOfIntervals=500,
    Tolerance=0.0001,
    __Dymola_Algorithm="dassl"));
end FMU_Physical_HP_HT_Control_Identification_ExternalInput;
