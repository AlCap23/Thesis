...
package FMU_Physical "Package for Physical Systems"
  package HP_HT_Control
    ...
    equation
      ...
      connect(Physical_System.nFan, u_1) annotation (Line(points={{-15,22},{-16,
              22},{-16,38},{-16,50},{-100,50}}, color={0,0,127}));
      connect(Physical_System.Ventil, u_2) annotation (Line(points={{7.8,22},{
              7.8,80},{-100,80}}, color={0,0,127}));
